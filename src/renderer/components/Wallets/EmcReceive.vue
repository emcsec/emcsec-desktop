    ...
    <div class="wrapper">
        <div class="col-md-8 col-md-offset-2">
            <div :class="address !== '' ? 'col-md-8 col-sm-8' : 'col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2'">
                <h5>{{ $I18n.translate('receive_emercoin') }}</h5>
                <form class="form">
                    <div class="form-group form-group-sm dd">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a role="button" class="addresses form-group-xs" :class="addr.address === address ? 'emc-bg' : ''" v-for="(addr, index) in addresses" @click="selectAddress(addr.address)">
                                        <p class="address-name">
                                            <input type="text" v-model="editedAddress.name" class="form-control address-name" v-if="isEdited && addr._id === editedAddress._id">
    ...
    export default {
      ...
      methods: {
        ...
        formatAmount () {
          ...
          this.inputError = false
          this.amount = this.number_format(this.amount, 6, '.', '')
        }
      }
    }
</script>
